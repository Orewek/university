...
if __name__ == '__main__':
    list_min = ['00', '05', '10', '15', '20', '25', '30',
                '35', '40', '45', '50', '55', '00']
    # list_folders = ['8.00-9.00 07.07.2022',
    #                 '9.00-10.00 07.07.2022',
    #                 '10.00-11.00 07.07.2022',
    #                 '11.00-12.00 07.07.2022']
    # mega_frame = '8.00-12.00 07.07.2022'
    # bad_videos = ['08.05', '08.35', '08.40', '09.35', '09.40',
    #               '09.45', '09.55', '10.40', '10.45', '11.55']
    # list_hour = ['08', '09', '10', '11']

    # list_folders = ['22.00-23.00 11.06.2023',
    #                 '23.00-24.00 11.06.2023',
    #                 '00.00-01.00 12.06.2023',
    #                 '01.00-02.00 12.06.2023']
    # mega_frame = '22.00-02.00 11-12.06.2023'
    # bad_videos = ['22.30', '23.10', '00.00', '00.25',
    #               '00.50', '01.50', '01.55']
    # list_hour = ['22', '23', '00', '01', '02']

    # list_folders = ['22.00-23.00 12.06.2023',
    #                 '23.00-24.00 12.06.2023',
    #                 '00.00-01.00 13.06.2023',
    #                 '01.00-02.00 13.06.2023']
    # mega_frame = '22.00-02.00 12-13.06.2023'
    # bad_videos = ['22.45', '23.45', '00.05', '00.35',
    #               '00.50', '01.10', '01.15',
    #               '01.30', '01.40', '01.45', '01.50']
    # list_hour = ['22', '23', '00', '01', '02']

    list_folders = ['22.00-23.00 13.06.2023',
                    '23.00-24.00 13.06.2023',
                    '00.00-01.00 14.06.2023',
                    '01.00-02.00 14.06.2023']
    mega_frame = '22.00-02.00 13-14.06.2023'
    bad_videos = ['22.30', '22.50', '23.20',
                  '23.25', '23.35', '00.15',
                  '01.10', '01.15', '01.20']
    list_hour = ['22', '23', '00', '01']
    ...
    excel_file = 'Разметка видео.xlsx'
