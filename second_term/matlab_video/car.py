...
detector_heigth = 30  # Высота детектора в пикселях
detector_width = 60  # Ширина детектора в пикселях
activation_avg_colour_delta = 1.5  # Значение разницы метрики в % при котором будет проходить активация детектора
